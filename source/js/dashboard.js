...
//                console.log(d)
	...
	//https://raw.githubusercontent.com/paolo-peretti/Dashboard-Crime/master/data/CCcrime.csv
	
d3.csv("https://raw.githubusercontent.com/paolo-peretti/Dashboard-Crime/master/data/CCcrime.csv", rowConverter, function(data) {
...
//                             console.log(primaryBool)
                            ...
                            if(CheckTwo){
                                ...
                                if(verify){
                                    tmpvalue = inputGetCC.value;
                                    dataset = CC(value);
                                     d3.select("#errorSelCC").classed("hidden", true);
                                    
                                }else{
                                     inputGetCC.value = tmpvalue;
